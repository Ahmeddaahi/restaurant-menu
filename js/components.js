        ...
        <div class="grid gap-12">
            ...
            <div class="bg-white p-6 rounded-[2rem] shadow-xl border border-gray-100 space-y-6">
                ...
                <div class="grid gap-4">
                    ...
                    <a href="tel:+251915745157" class="flex items-center gap-4 rounded-3xl border border-gray-100 p-4 hover:border-primary transition-colors bg-gray-50">
                        <div class="w-12 h-12 bg-white rounded-3xl flex items-center justify-center text-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold">+251 91 574 5157</p>
                        </div>
                    </a>

                    <a href="https://wa.me/251915745157" target="_blank" class="flex items-center gap-4 rounded-3xl border border-gray-100 p-4 hover:border-green-500 transition-colors bg-gray-50">
